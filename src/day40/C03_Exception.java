...
public class C03_Exception {
	...
	public static void main(String[] args) {
		...
		//kullanicidan sayi isteyin ve girilen sayi index olarak kabul edip
		// o index^deki elementi yazdirin
		
		
		int arr[]= {2,3,5,6,2,7,9,1};
		//Array›ndexOutOfBoundsException
		//›nputM›smatchException
		try {
...
System.out.println("girdiginiz indexdeki element :" + arr[index]);
           ...
           System.out.println("girdiginiz index array'da yok");
